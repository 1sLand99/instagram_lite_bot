...
//	err := outlook.Test()
//	log.Info("%v", err)
//	//code, err := ctrl.WaitForInstagram(outlook.BaseEmail)
//	//code, err := ctrl.WaitForCodeMessenger(outlook.BaseEmail)
//	//outlook.WaitForCode("registration@facebookmail.com",
//	//	outlook.GetAccount().Username,
//	//	func(_email *email.BaseEmail, resp *email.RespEmail) (string, error) {
//	//		log.Info("find")
//	//		return "", nil
//	//	})

...
const (
	...
	MsgCodeUnknow321                       = 321 // when recv 329 and other
...
func init() {
	...
	RegisterMessageCode(true, MsgCodeUnknow321, "Unknow321", reflect.TypeOf((*sender.Unknow321)(nil)).Elem())
	...
	RegisterMessageCode(true, MsgCodeSendNetworkInfo, "SendTextMsg", reflect.TypeOf((*sender.NetworkInfo)(nil)).Elem())
	...
	RegisterMessageCode(false, MsgCodeScreenReceived, "ScreenReceived", reflect.TypeOf((*recver.ScreenReceived)(nil)).Elem())
